<?php
	session_start();
?>
<h1>Please wait we are tranferring you in paypal...</h1>
<?php
...
<form action="<?php echo $paypal_url; ?>/cgi-bin/webscr" method="post" name="buyCredits" id="buyCredits">
	...
	<input type="hidden" name="return" value="https://localhost/youtube_project/user/payment_success.php?id=<?php echo $order_id; ?>">
</form>
